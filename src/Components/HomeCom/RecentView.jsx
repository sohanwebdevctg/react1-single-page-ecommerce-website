  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-4 md:gap-2 lg:gap-3 xl:gap-4 2xl:gap-5">
        {/* item section start */}
        {
          datas.map((data, id) => <div key={data.id} className="overflow-hidden rounded-lg shadow-lg shadow-slate-300 mainCon group relative" data-aos="zoom-in" data-aos-duration="1500">
