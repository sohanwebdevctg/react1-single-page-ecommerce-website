...
const BannerSlider = () => {
  ...
  const bannerData = [
    ...
    {id: 10, image : '/public/home/banner10.png'},
  ]
    ...
    >
      {/* item section start */}
      {
        ...
        <div className='overflow-hidden'>
          <img src={data.image} alt={`this is banner slider ${data.id}`} width={200} height={200} className='w-56 h-56 sm:w-48 sm:h-48 md:w-48 md:h-48 lg:w-56 lg:h-56 xl:w-[300px] xl:h-[310px] mx-auto text-center p-5'></img>
        </div>
      </SwiperSlide>)
      }
